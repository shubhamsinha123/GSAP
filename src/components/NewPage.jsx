...
function createData(name, ids, calories, fat, carbs, protein) {
  return {
    name,
    ids,
    calories,
...
const rows = [
  ...
  createData("Donut", 2, 452, 25.0, 51, 4.9),
  createData("Eclair", 3, 262, 16.0, 24, 6.0),
  createData("Frozen yoghurt", 4, 159, 6.0, 24, 4.0),
  createData("Gingerbread", 5, 356, 16.0, 49, 3.9),
  createData("Honeycomb", 6, 408, 3.2, 87, 6.5),
  createData("Ice cream sandwich", 7, 237, 9.0, 37, 4.3),
  createData("Jelly Bean", 8, 375, 0.0, 94, 0.0),
